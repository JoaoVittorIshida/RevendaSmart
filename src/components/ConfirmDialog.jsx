                    ...
                    >
                        <div className="flex items-start justify-between p-6 pb-4">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-xl ${dialog.variant === 'danger' ? 'bg-red-50 text-red-500 dark:bg-red-900/30 dark:text-red-400' :
                                        dialog.variant === 'warning' ? 'bg-orange-50 text-orange-500 dark:bg-orange-900/30 dark:text-orange-400' :
                                            'bg-blue-50 text-blue-500 dark:bg-blue-900/30 dark:text-blue-400'
                                    }`}>
                                    <AlertTriangle size={20} />
                                </div>
                                <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">{dialog.title}</h3>
                            </div>
                            <button
                                onClick={() => close(false)}
